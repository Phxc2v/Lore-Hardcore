...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <!-- ============ Ungor raider стрелы (QA тест №2) ============ -->
    <!-- Унгорский разбойник: колющий стрел 0→1 — свап default_arrows → barbed_arrows (vanilla thrust=1). -->
    <xsl:template match="EquipmentRoster[@id='tor_beast_ungor_raider_template']//Equipment[@id='Item.default_arrows']/@id">
        <xsl:attribute name="id">Item.barbed_arrows</xsl:attribute>
    </xsl:template>
    <!-- Унгорский полурогий разбойник: колющий 1→2 — свап barbed_arrows → наш tor_lh_ungor_pierce_arrows (thrust=2). -->
    <xsl:template match="EquipmentRoster[@id='tor_beast_ungor_raider_chief_template']//Equipment[@id='Item.barbed_arrows']/@id">
        <xsl:attribute name="id">Item.tor_lh_ungor_pierce_arrows</xsl:attribute>
    </xsl:template>
</xsl:stylesheet>
